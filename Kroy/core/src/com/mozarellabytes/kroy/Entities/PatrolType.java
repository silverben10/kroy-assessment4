...
/** The preset values for the different truck types includes the type's:
    ...
    Red(new Texture(Gdx.files.internal("sprites/Patrol/redPatrol.png")), 250, 3, "Red Patrol", 7, 0.16f, 100, new Vector2(3, 4), new Vector2(9, 16), new Vector2(31, 21), new Vector2(26, 9)),
